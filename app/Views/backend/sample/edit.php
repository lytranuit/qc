                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="ml-auto">
                                                <a class="btn btn-success text-white"
                                                    onclick="printJS('<?= base_url($tin->image_url) ?>', 'image')"><i
                                                        class="fas fa-print"></i> Print</a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <a href="<?= base_url($tin->image_url) ?>" target="_blank"
...
<script type='text/javascript'>
    ...
    if (tin.code_research) {
        let val = tin.code_research;
        let exists = false;
        $("#code_research_select option").each(function () {
            if ($(this).val() == val) {
                exists = true;
            }
        });
        if (exists) {
            $("#code_research_select").val(val);
        } else if (val.trim() != "") {
            $("#code_research_select").val("custom");
            $(".code_research_custom_input").val(val).show();
        }
    }
    ...
    $(document).ready(function () {
        ...
        // When storage_id of a row changes, re-evaluate summary
        ...
        // When type_id of a row changes, re-evaluate summary
    ...
    function updateStorageSummary() {
        ...
        // Sub-header row: tên khu vực lưu mẫu
        html += '<tr class="text-center">';
