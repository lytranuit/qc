...
<template class="times">
    <div class="form-group row p-1 item" data-id="{{id}}">
        <div class="col-2">
        ...
        <div class="col-2">
            <textarea type="text" name="note" class="form-control form-control-sm note" rows="1" placeholder="Ghi chú" style="width:70%;display:inline-block;vertical-align: middle;"></textarea>
