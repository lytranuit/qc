...
<template class="time">
    <div class="form-group row pt-1">
        <div class="col-2">
            <input type="number" name="time[]" class="form-control form-control-sm" value="{{time}}">
        </div>
        <div class="col-4">
            <select class="form-control form-control-sm" name="type_time[]" value="{{type_time}}">
        ...
        <div class="col-4">
            <select class="form-control form-control-sm" name="based[]" value="{{based}}">
...
<script type='text/javascript'>
    ...
    $(document).ready(function() {
        if (tin.time) {
            ...
            $(".list_time select").each(function() {
